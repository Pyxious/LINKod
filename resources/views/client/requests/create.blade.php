...
class="w-full max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row gap-6 items-start font-sans">
    ...
    <div class="flex-1 bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        ...
        <div class="space-y-5">
            ...
            <div class="flex justify-end pt-2">
                <button type="submit" x-bind:disabled="submitting" x-text="submitting ? 'Submitting...' : 'Submit Request'" class="px-8 py-3 bg-[#0033a0] text-white rounded-lg font-semibold text-sm hover:bg-[#002480] transition shadow-md disabled:opacity-50 disabled:cursor-not-allowed">
                    Submit Request
                </button>
            </div>
        </div>
