...
<head>
    ...
    <title>{{ $title ?? 'Worker Dashboard — BU-GSO LINKod' }}</title>
    @auth
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="relative" x-data="{ openNotifs: false, activeTab: 'all' }">
                ...
                <div x-show="openNotifs" 
                     ...
                     x-cloak 
                     class="fixed left-4 right-4 sm:absolute sm:left-auto sm:right-0 top-14 sm:top-auto sm:mt-2 w-auto sm:w-[390px] bg-white dark:bg-[#18181b] border border-gray-200 dark:border-zinc-800 rounded-2xl shadow-2xl overflow-hidden z-50 text-left">
                    ...
                    <div class="p-2.5 border-t border-gray-100 dark:border-zinc-800 bg-gray-50/70 dark:bg-zinc-800/40 text-center">
                        <a href="{{ route('worker.notifications.index') }}" class="text-xs font-bold text-[#0033a0] dark:text-blue-400 hover:underline inline-flex items-center gap-1">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
        ...
        <div class="px-5 pt-6 pb-5 border-b border-[#f0f0e0] dark:border-gray-800 flex justify-between items-center">
            ...
            <div class="flex items-center gap-1">
                ...
                <div class="relative hidden md:block" x-data="{ openNotifs: false, activeTab: 'all' }">
                    <button @click="openNotifs = !openNotifs" 
                            type="button" 
                            title="Notifications"
                            class="p-1.5 rounded-lg text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition relative focus:outline-none cursor-pointer">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                        </svg>
                        <span data-notification-badge class="absolute -top-1 -right-1 bg-red-500 text-white text-[9px] font-black px-1.5 py-0.2 rounded-full border border-white dark:border-zinc-900 animate-pulse {{ ($navUnreadCount ?? 0) > 0 ? '' : 'hidden' }}">
                    ...
                    <div x-show="openNotifs" 
                         ...
                         x-cloak 
                         class="fixed left-[236px] top-5 w-[390px] bg-white dark:bg-[#18181b] border border-gray-200 dark:border-zinc-800 rounded-2xl shadow-2xl overflow-hidden z-[999999] text-left">
            ...
            <div class="relative" @click.outside="openProfile = false">
                ...
                <div x-show="openProfile" 
                    ...
                    <div class="py-1">
                        ...
                        <a href="{{ route('worker.profile.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-800 transition">
