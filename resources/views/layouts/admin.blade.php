...
<body x-data="{ sidebarOpen: false }" class="bg-[#f0f4f8] dark:bg-[#111111] text-slate-800 dark:text-gray-200 antialiased flex flex-col md:flex-row min-h-screen transition-colors duration-200">
            ...
            <div class="relative" x-data="{ openNotifs: false, activeTab: 'all' }">
                ...
                <div x-show="openNotifs" 
                    ...
                    <div class="p-2.5 border-t border-gray-100 dark:border-zinc-800 bg-gray-50/70 dark:bg-zinc-800/40 text-center">
                        <a href="{{ route('admin.notifications.index') }}" class="text-xs font-bold text-[#0033a0] dark:text-blue-400 hover:underline inline-flex items-center gap-1">
    ...
    <div class="md:ml-56 flex-1 flex flex-col min-h-screen w-full">
        ...
        @unless(View::hasSection('hide_alerts'))
            <div class="fixed top-6 left-1/2 -translate-x-1/2 z-50 pointer-events-none w-full max-w-sm sm:max-w-md px-4 space-y-3">
                @if(session('success'))
