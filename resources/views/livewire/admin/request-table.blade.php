<div wire:poll.10s>
    ...
    <div class="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-3 mb-4">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <div class="relative">
                <div wire:loading.remove wire:target="search" class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-[#1a3c8f] dark:text-blue-400">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                    </svg>
                </div>
                <div wire:loading wire:target="search" class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-[#0038A8] dark:text-blue-400">
